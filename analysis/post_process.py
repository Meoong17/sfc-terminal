...
nav .nav-center { display: flex; align-items: center; gap: 2px; margin: 0 auto; }
nav .nav-tab {
...
nav .nav-tab:hover { color: var(--text-1); background: rgba(255,255,255,0.04); border-color: rgba(255,255,255,0.08); }
nav .nav-tab.active { color: #fff; background: rgba(120,100,255,0.1); border-color: rgba(120,100,255,0.25); }

/* Cards: subtle translucent */
.main .kpi-card, .main .metric-card, .main .chart-card, .main .card {
