...
# ── Cache path ──
_CACHE_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), '.etf_cache.json')
...
def compute_etf_metrics(btc_price=None):
    ...
    details = {
        ...
        "m82_cumulative_btc": round(cum, 1),
        "m82_cumulative_usd": round(cache.get("cumulative_usd", 0), 0),
